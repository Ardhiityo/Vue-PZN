...
const { formTypes } = defineProps(['formTypes']);
            ...
            <form @submit.prevent="handleSubmit">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                    <div>
                        ...
                        <p v-if="errors.first_name" class="text-red-500 text-sm font-bold">
                            {{ errors.first_name }}
                        </p>
                    </div>
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="last_name" name="last_name"
                                class="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                                placeholder="Enter last name" v-model="contact.last_name" />
                        </div>
                        <p v-if="errors.last_name" class="text-red-500 text-sm font-bold">
                            {{ errors.last_name }}
                        </p>
                    </div>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <p v-if="errors.email" class="text-red-500 text-sm font-bold">
                        {{ errors.email }}
                    </p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <p v-if="errors.phone" class="text-red-500 text-sm font-bold">
                        {{ errors.phone }}
                    </p>
                </div>
                ...
                <div class="flex justify-end space-x-4">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-plus-circle mr-2"></i> Save Contact
                    </button>
                </div>
            </form>
        </div>
